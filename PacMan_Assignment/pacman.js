...
// Inside of the Run() function you will also have to add an extra argument "pageWidth", which is declared on line 4 when you call 
// the checkPageBounds() function below. 
setInterval(Run,200);
